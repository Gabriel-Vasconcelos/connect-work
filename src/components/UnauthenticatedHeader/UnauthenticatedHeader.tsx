    ...
    <header className="w-full bg-sky-600 py-10 text-white">
      <div className="site--container flex justify-between items-center w-full">
        ...
        <nav className="max-lg:hidden flex text-lg items-center gap-x-4">
          <Link href="#" title="Dúvidas">Dúvidas</Link>
          <Link href="#" title="Contato">Contato</Link>
          <Link className="ml-5 w-full" href="/login" title="Clique para logar">
            <Button size="lg" className="w-full text-lg font-bold max-w-40 py-5">Entrar</Button>
          </Link>
        </nav>
              ...
              <div className="flex flex-col p-4 h-full">
                ...
                <DrawerClose asChild>
                  <Link href="/login" className="mt-auto">
                    <Button size="lg" className="w-full text-lg font-bold py-5">Entrar</Button>
                  </Link>
                </DrawerClose>
              </div>
            </DrawerContent>
