...
export default function Home() {
  return (
    <div className="mb-8 w-full">
      ...
      <FeaturedText imageSrc="/assets/group-people.png" title="Porque escolher a ConnectWork?" description="A ConnectWork não é apenas mais uma plataforma de conexão de serviços—é a solução que sua empresa precisa para transformar desafios em oportunidades. Escolher a ConnectWork significa optar por eficiência, segurança e resultados que realmente fazem a diferença." />
